...
export function HotelFlowLogo({ size = "md", showText = true, className = "" }: LogoProps) {
  ...
  return (
    <div className={`flex items-center gap-3 ${className}`}>
      <div
        className="bg-gradient-to-br from-blue-600 to-blue-700 rounded-2xl shadow-float flex items-center justify-center p-2 relative overflow-hidden transition-transform duration-300 hover:scale-105"
