...
export function HotelFlowLogo({ size = "md", showText = true, className = "", logoUrl }: LogoProps) {
  const dimensions = {
  ...
  return (
    <div className={`flex items-center gap-3 ${className}`}>
      <div
        className="bg-gradient-to-br from-blue-600 to-blue-700 rounded-2xl shadow-float flex items-center justify-center p-1.5 relative overflow-hidden transition-transform duration-300 hover:scale-105"
        style={{ width: dimensions.box, height: dimensions.box }}
      >
        {logoUrl ? (
          <img src={logoUrl} alt="Hotel Logo" className="w-full h-full object-cover rounded-xl" />
        ) : (
          <svg
            viewBox="0 0 24 24"
            fill="none"
          ...
          >
            {/* Wallet Icon */}
            <path d="M19 7h-2v-2a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-2" />
